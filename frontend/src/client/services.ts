...
export class UsersService {
  ...
  public static getUserSubscriptions(
    data: UsersData["GetUserSubscriptions"] = {},
  ): CancelablePromise<Array<SubscriptionPublic>> {
...
export class ConfigsService {
  ...
  public static getConfig(
    data: ConfigsData["GetConfig"],
  ): CancelablePromise<ConfigPublic> {
  ...
  public static updateConfig(
    data: ConfigsData["UpdateConfig"],
  ): CancelablePromise<unknown> {
    const { subscriptionId, requestBody } = data
    return __request(OpenAPI, {
      method: "PATCH",
      url: "/api/v1/configs/{subscription_id}/job-preferences",
      path: {
  ...
  public static getPlainTextResume(
    data: ConfigsData["GetPlainTextResume"],
  ): CancelablePromise<PlainTextResumePublic> {
    const { subscriptionId } = data
    return __request(OpenAPI, {
      method: "GET",
  ...
  public static updatePlainTextResume(
    data: ConfigsData["UpdatePlainTextResume"],
...
export class SubscriptionService {
  ...
  public static readSubscriptionPlans(
    data: SubscriptionData["ReadSubscriptionPlans"] = {},
  ): CancelablePromise<SubscriptionPlansPublic> {
    const { onlyActive = true } = data
    return __request(OpenAPI, {
      method: "GET",
  ...
  public static createSubscriptionPlan(
    data: SubscriptionData["CreateSubscriptionPlan"],
  ): CancelablePromise<SubscriptionPlanPublic> {
    const { requestBody } = data
    return __request(OpenAPI, {
      method: "POST",
      url: "/api/v1/subscription/plans",
  ...
  public static readSubscriptionPlan(
    data: SubscriptionData["ReadSubscriptionPlan"],
  ): CancelablePromise<SubscriptionPlanPublic> {
    const { id } = data
    return __request(OpenAPI, {
      method: "GET",
  ...
  public static updateSubscriptionPlan(
    data: SubscriptionData["UpdateSubscriptionPlan"],
  ): CancelablePromise<Message> {
  ...
  public static deleteSubscriptionPlan(
    data: SubscriptionData["DeleteSubscriptionPlan"],
  ): CancelablePromise<Message> {
    const { id } = data
    return __request(OpenAPI, {
      method: "DELETE",
...
export class CheckoutService {
   ...
   * @throws ApiError
   */
  public static getStripeCheckoutSession(
    data: CheckoutData["GetStripeCheckoutSession"],
  ): CancelablePromise<CheckoutSessionPublic> {
    const { subscriptionPlanId } = data
    return __request(OpenAPI, {
      method: "POST",
   ...
   * @throws ApiError
   */
  public static getStripeCheckoutSession1(
    data: CheckoutData["GetStripeCheckoutSession1"],
