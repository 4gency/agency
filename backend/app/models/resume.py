...
class PersonalInformation(EmbeddedModel):
    name: str = "John"
    surname: str = "Doe"
    date_of_birth: str = (datetime.date.today() - datetime.timedelta(days=30*365)).isoformat()
    country: str = "USA"
    city: str = "New York"
...
class PlainTextResumePublic(BaseModel, extra="ignore"):
    ...
    education_details: list[EducationDetails] = [EducationDetails(),]
    experience_details: list[ExperienceDetail] = [ExperienceDetail(),]
